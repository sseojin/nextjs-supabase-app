 ...
 */
export default function JoinProjectClient({ projectId, shareLink }: JoinProjectClientProps) {
  ...
  useEffect(() => {
    ...
    const isReturningFromLogin = sessionStorage.getItem(`returning-from-login-${shareLink}`);
  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-gray-900 font-semibold py-3 px-4 rounded-lg transition-colors min-h-[48px] md:min-h-[44px]"
      >
